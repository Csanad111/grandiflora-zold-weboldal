import svgPaths from "./svg-hdqv1i989m";
...
import { imgBlur, imgBlur1, imgBlur2 } from "./svg-4v0sm";
...
function User({ className }: { className?: string }) {
  return (
    <div className={className || "absolute left-[calc(80%+35.6px)] size-[24px] top-[52px]"} data-name="User">
...
function TemperatureLight({ className }: { className?: string }) {
  return <div className={className || "absolute left-[calc(80%+8.6px)] size-[24px] top-[calc(5%+29.1px)]"} data-name="Temperature_light" />;
}
...
export default function IPhone1415Pro() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 14 & 15 Pro - 2">
      <div className="absolute h-[99px] left-0 top-0 w-[393px]">
        <div className="absolute inset-[-16.16%_-4.07%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 425 131">
            <g filter="url(#filter0_d_1_1719)" id="Rectangle 10">
              <path d="M16 16H409V115H16V16Z" fill="var(--fill-0, #F3EDF7)" fillOpacity="0.77" shapeRendering="crispEdges" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="131" id="filter0_d_1_1719" width="425" x="0" y="0">
                ...
                <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_1719" />
                <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_1719" mode="normal" result="shape" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute h-[16px] left-[calc(10%-18.3px)] top-[calc(5%+11.1px)] w-[11px]" data-name="Vector">
        <div className="absolute inset-[-3.13%_-4.55%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 17">
            <path d={svgPaths.p150a5000} id="Vector" stroke="var(--stroke-0, #5E6E5E)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
      <p className="absolute font-['Inria_Serif:Regular',sans-serif] h-[14px] leading-[normal] left-[calc(10%-8.3px)] not-italic text-[#5e6e5e] text-[16px] top-[calc(5%+9.1px)] tracking-[0.112px] w-[35px]">{` 18°C`}</p>
      ...
      <div className="absolute h-[195px] left-[calc(10%-18.3px)] top-[calc(40%+15.8px)] w-[351px]" data-name="Gombok">
        <Shadow4 />
        <GlassEffect4 />
        <div className="absolute bg-[#5e6e5e] inset-[31.79%_17.66%_34.87%_17.66%] rounded-[20px]" />
        <p className="absolute font-['DM_Serif_Display:Regular',sans-serif] inset-[39.49%_29.06%_42.56%_28.77%] leading-[normal] not-italic text-[20px] text-white tracking-[0.14px]">Időpontfoglalás</p>
      </div>
      <div className="absolute h-[195px] left-[calc(10%-18.3px)] top-[calc(70%-17.6px)] w-[351px]" data-name="Gombok">
        <Shadow5 />
        <GlassEffect5 />
        <div className="absolute bg-[#5e6e5e] inset-[31.79%_17.66%_34.87%_17.66%] rounded-[20px]" />
        <p className="absolute font-['DM_Serif_Display:Regular',sans-serif] inset-[39.49%_29.06%_42.56%_28.77%] leading-[normal] not-italic text-[20px] text-white tracking-[0.14px]">Előtte - utána</p>
      </div>
    </div>
  );
}